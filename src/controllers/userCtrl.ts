...
const userCtrl = {
  register: async (req: Request, res: Response) => {
    try {
      ...
      await transporter.sendMail({
        from: "Learning Management System || Register Verification",
        to: to,
        subject: "Email Verification Link - Learning Management System",
        html: `<!doctype html>
    <html lang=en>
    <head>
    <meta charset=utf-8>
    ...
    <title>Learning Management System || Register Verification</title>
    </head>
    <body>
    <div class="container-fluid bg-primary text-center"><h1 class="text-white p-5">Learning Management System || Register Verification</h1></div>
  ...
  login: async (req: Request, res: Response) => {
    try {
      ...
      await transporter.sendMail({
        from: "Learning Management System || Login Verification",
        to: user.email,
        subject: "Email Verification Link - Learning Management System",
        html: `<!doctype html>
    <html lang=en>
    ...
    <title>Learning Management System || Login Two Step Verification</title>
    </head>
    <body>
    <div class="container-fluid bg-primary text-center"><h1 class="text-white p-5">Learning Management System || Login Two Step Verification</h1></div>
  ...
  forgotPassword: async (req: Request, res: Response) => {
    try {
      ...
      await transporter.sendMail({
        from: "Learning Management System || Forgot Password",
        to: user.email,
        subject: "Email Verification Link - Learning Management System",
        html: `<!doctype html>
<html lang=en>
...
<body>
<div class="container-fluid bg-primary text-center"><h1 class="text-white p-5">Learning Management System || Forgot Password</h1></div>
